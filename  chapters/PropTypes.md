...
React предоставляет внутренний механизм для добавления проверки типов у компонентов. 

React-компоненты используют специальное свойство именуемое, как `propTypes`, для установки проверки типа.


Пример работы `propTypes`:
...
Список доступных типов, которые используются для работы с `propTypes`:
